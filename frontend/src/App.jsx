...
function HomePage({ movies, navigate, searchQuery, setSearchQuery, selectedGenre, setSelectedGenre, selectedYear, setSelectedYear, isGenreOpen, setIsGenreOpen, isYearOpen, setIsYearOpen, filteredMovies, allGenres, allYears, loading }) {
